...
import com.elsevier.utils.DynamoDBUtils;
import com.elsevier.utils.KinesisUtils;
import com.elsevier.utils.RedshiftUtils;
import com.elsevier.utils.S3Utils;
...
public abstract class KinesisConnectorExecutor<T,U> extends KinesisConnectorExecutorBase<T,U> {
    ...
    private void setupInputStream() {
        if (parseBoolean(CREATE_STREAM_SOURCE, DEFAULT_CREATE_STREAM_SOURCE, properties)) {
           // Following logic is not needed because we are not creating the kinesis stream (it already exists)
    ...
    private static List<String> getKinesisMessageModelFields() {
        ...
        fields.add("docid varchar(30) not null");
        fields.add("key varchar(30) not null");
        fields.add("action varchar(10) not null");
        fields.add("epoch varchar(30) not null");
        fields.add("timestamp varchar(30) not null");
        return fields;
    }
