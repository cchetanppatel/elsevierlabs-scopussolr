...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<xsl:template match="ft:fullTextQuery[ft:word | ft:andQuery | ft:orQuery | ft:notQuery | ft:numericCompare | ft:proximityQuery | ft:scopeQuery]">
		<xsl:apply-templates select="ft:word | ft:andQuery | ft:orQuery | ft:notQuery | ft:numericCompare | ft:proximityQuery | ft:scopeQuery">
			<xsl:with-param name="p">0</xsl:with-param> 
		</xsl:apply-templates>	
	</xsl:template>
