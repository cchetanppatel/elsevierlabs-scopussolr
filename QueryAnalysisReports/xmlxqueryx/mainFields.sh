#!/bin/bash
filename="/Users/mcbeathd/ScopusSearchQueries/xmlxqueryx/SCOPUS_MAIN_FULLTEXTQUERY_10152013.txt"
#filename="/Users/mcbeathd/ScopusSearchQueries/xmlxqueryx/citeid.txt"
